...
def render_floating_chat(df, rfm_df):
    ...
    js_fallback_hack = '<img src="x" onerror=\'(function(){var applyStyles=function(){var doc=window.parent.document||document;var buttons=Array.from(doc.querySelectorAll("button"));var chatBtn=buttons.find(function(b){return b.innerText&&b.innerText.indexOf("🤖")>-1;});if(chatBtn){var btnCont=chatBtn.closest("div.element-container")||chatBtn.closest("div[data-testid=\\"element-container\\"]");if(btnCont){btnCont.style.setProperty("position","fixed","important");btnCont.style.setProperty("bottom","30px","important");btnCont.style.setProperty("right","30px","important");btnCont.style.setProperty("z-index","999999999","important");btnCont.style.setProperty("width","70px","important");btnCont.style.setProperty("height","70px","important");btnCont.style.setProperty("display","block","important");chatBtn.style.setProperty("border-radius","50%","important");chatBtn.style.setProperty("width","70px","important");chatBtn.style.setProperty("height","70px","important");chatBtn.style.setProperty("font-size","32px","important");chatBtn.style.setProperty("box-shadow","0 10px 30px rgba(0,0,0,0.3)","important");chatBtn.style.setProperty("background-color","#ffd400","important");}}var winAnc=doc.querySelector(".chat-window-anchor");if(winAnc){var ancCont=winAnc.closest("div.element-container")||winAnc.closest("div[data-testid=\\"element-container\\"]");if(ancCont){var winCont=ancCont.nextElementSibling;if(winCont){winCont.style.setProperty("position","fixed","important");winCont.style.setProperty("bottom","110px","important");winCont.style.setProperty("right","30px","important");winCont.style.setProperty("z-index","999999998","important");winCont.style.setProperty("width","380px","important");winCont.style.setProperty("height","550px","important");winCont.style.setProperty("display","block","important");winCont.style.setProperty("box-shadow","0 12px 40px rgba(0,0,0,0.25)","important");}}}};applyStyles();setTimeout(applyStyles,100);setTimeout(applyStyles,400);setTimeout(applyStyles,1000);})();\' style="display:none;"/>'
